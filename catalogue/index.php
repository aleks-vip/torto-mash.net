...
?>
	...
	<section class="clearfix">	
		<div class="container">
			<div class="cena">
		<p>Торты от 700/850руб за кг, минимум 2 кг</p>	
		<p>Подробнее по телефону +7 (961) 993-50-42</p>
			</div>
			<div id="mainmenu">
				<ul>
					<li>
					...
					<li>
						<a href="mans/index.php">Мужчинам</a>
					</li>
					<li>
				...
				<div class="goods">
					<?php
						$result = mysql_query("SELECT * FROM holidays", $link);
					if (mysql_num_rows($result)>0) 
					{
						...
						do {
							...
							echo '
								...
								<img class="razmer" src="img/goods/holidays/'.$row["img"].'" alt="">
								<div class="overlei">
									<p>'.$row["number"].'</P>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p id="text_change"> <?php echo $row["number"]; ?> </p>
      ...
      <img name="img" class="img_forma" src=" " alt="">
		...
		<input type="hidden" name="article" id="input1" value="<?php echo $row["number"]; ?>">
		<li>
 		...
 		<li>
 		<button class="botn_stil pozicia" href="trade/index.html" type="submit" onClick="alert('Спасибо за проявленный интерес! Мы свяжемся с вами в ближайшее время.')">Перезвоните мне</button></li></ul></div>
 		<div class="centr overlei">
 		 <p class="soglasie">
